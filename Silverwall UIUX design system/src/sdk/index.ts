...
const tablesSchema = __schema({
  ...
  constructor_standings: __table({
    name: 'constructor_standings',
    indexes: [
      { name: 'season_year', algorithm: 'btree', columns: [
        'seasonYear',
      ] },
    ],
    constraints: [
  ...
  telemetry: __table({
    name: 'telemetry',
    indexes: [
      { name: 'driver_number', algorithm: 'btree', columns: [
        'driverNumber',
      ] },
  ...
  track_point: __table({
    name: 'track_point',
    indexes: [
      { name: 'circuit_key', algorithm: 'btree', columns: [
        'circuitKey',
      ] },
    ],
    constraints: [
